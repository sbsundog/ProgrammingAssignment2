...
## cacheMatrix.R contains two major functions: 
##      makeCachematrix and cacheSolve
##      makeCachematrix creates a special "matrix" object from a matrix
...
## but for matrices rather than vectors. References in makeVector function
...
## calculated and the matrix has not changed. It is an aanalogue of
## te function cachemean, but for matrices rather than vectors.
